...
@section('contenido')
    <div class="bg-blue-950 text-center py-14 px-8">
        <h1 class="text-4xl font-bold text-white">Editar aviso</h1>
        <p class="text-blue-200 mt-3 text-lg">Corrige el contenido y guarda los cambios</p>
    </div>
